...
namespace Migrator
{
    ...
    class Program
    {
        ...
        static string mongoConnectionString = "mongodb+srv://zhandmin:MqUdwUf7KYaiQsnx@mflix.co46qob.mongodb.net/?retryWrites=true&w=majority";
        ...
        static async Task Main(string[] args)
        {
            ...
            if (ratingPipelineResults.Count > 0)
            {
                ...
                foreach (var doc in ratingPipelineResults)
                    updates.Add(new ReplaceOneModel<Movie>(doc.Id, doc));
