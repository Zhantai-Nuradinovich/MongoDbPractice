        ...
        */
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                //
                await _usersCollection.WithWriteConcern(new WriteConcern(1)).InsertOneAsync(user, new InsertOneOptions(), cancellationToken);
                //
        ...
        public async Task<UserResponse> LoginUserAsync(User user, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                await _sessionsCollection.UpdateOneAsync(
                        ...
                        Builders<Session>.Update.Set("user_id", user.Email)
                                                .Set("jwt", user.AuthToken),
